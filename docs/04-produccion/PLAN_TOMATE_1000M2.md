...
```mermaid
graph TD
    A["Casa de Malla 1.000 m² (20m x 50m)"] --> B["Marco: 10 Camellones Dobles = 2.200 Plantas (2.20 pl/m²)"]
    A --> C["Riego: 2 Sectores Balanceados (2.00 m³/h c/u — Bomba 1.5 HP)"]
    A --> D["Nutrición: Fertirriego 100% AIFA Hidrosoluble (Tanques A, B, C)"]
    ...
    B --> G["Meta: 16.5 a 18.7 Toneladas (825 – 935 Cestas)"]
    C --> G
    D --> G
    E --> G
    F --> G
