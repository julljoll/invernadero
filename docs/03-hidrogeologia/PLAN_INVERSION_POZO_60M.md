...
```mermaid
gantt
    title Cronograma de Ejecución Física del Pozo (14 Días)
    dateFormat  D
    axisFormat  Día %d
    
    section Fase 1: Habilitación
    Acometida Eléctrica y Montaje de Soplador       :active, d1, 0, 2d
    Instalación de Bomba de Achique de Lodos        :d2, 1, 2d
    
    section Fase 2: Pica en Grava
    Pica Manual en Grava con Achique (50m a 55m)    :crit, d3, 2, 4d
    Pica Manual en Grava con Achique (55m a 60m)    :crit, d4, 6, 4d
    
    section Fase 3: Filtrado
    Bajada de Camisa PVC 8" Ranurada y Grava 1/4"   :d5, 10, 2d
    
    section Fase 4: Equipamiento
    Instalación de Bomba Definitiva 2 HP y Aforo 24h:done, d6, 12, 2d
```
