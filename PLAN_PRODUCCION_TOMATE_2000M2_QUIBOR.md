...
```mermaid
graph TD
    A["Casa de Malla 2.000 m² (20m x 100m)"] --> B["Marco: 10 Camellones Dobles = 4.400 Plantas (2.2 pl/m²)"]
    A --> C["Riego: Goteo Autocompensante PC/ND (2.000 m líneas)"]
    A --> D["Nutrición: Fertirriego Salino Equilibrado (Tanques A, B, C)"]
    A --> E["Sanidad: Matriz IRAC/FRAC + Foco en Ácaros y Blindaje ToBRFV"]
    A --> F["Tutorado: Hortomalla 15x15 cm + Topping a 2.20 m (-88% Mano de Obra)"]
    
    B --> G["Meta: 28.6 a 37.4 Toneladas de Tomate de Primera"]
    C --> G
    D --> G
    E --> G
    F --> G
...
### 5.1. Selección de Malla (110 gsm, 50 Mesh, Color Blanco) y el Punto Crítico de Ácaros en Quíbor
La selección de la **malla anti-insectos 110 gsm, 50 mesh (50×25 hilos/pulgada) HDPE monofilamento en color blanco** responde a una doble necesidad bioclimática y agronómica en el Valle de Quíbor:
1. **Circulación de Aire y Ventilación Convectiva:** El gramaje de 110 gsm equilibra la densidad de los 50 hilos/pulgada con un paso de aire aerodinámicamente fluido, facilitando la extracción del aire caliente acumulado en el colchón térmico superior de 1.00 m.
2. **Opacidad y Difusión Solar:** El color blanco refleja la radiación infrarroja no fotosintética y dispersa la luz PAR, evitando el sobrecalentamiento interno de la nave (>31.5 – 32.0 °C) y neutralizando el riesgo de aborto floral inducido por calor en las horas pico del mediodía.
3. **Barrera Fitosanitaria:** Retiene al 100% insectos voladores medianos y grandes (mosca blanca, trips, pulgón, minador, polillas). Sin embargo, los **ácaros fitófagos poseen dimensiones de 120 a 180 micras** y atraviesan físicamente cualquier poro comercial. Por tanto, la defensa anti-ácaros es **100% de manejo preventivo y monitoreo agronómico**:
