...
function crearHojaCalculoGastos(ss) {
  ...
  var data = [
    ...
    ['4. Sistema de Riego & Cabezal', 'Sistema de Riego por Goteo (goteros PC/AS 1.6 L/h autocompensados + cabezal y filtros)', 'Cinta 1.000m + goteros PC/AS 1.6 L/h + cabezal y filtros de disco', 'OPEX / CAPEX', 'Kit 1.000 m²', 100, 0.014],
