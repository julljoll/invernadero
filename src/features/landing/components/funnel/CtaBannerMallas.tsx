          ...
          <div className="row g-4 align-items-center">
            <div className="col-12 col-lg-8">
              ...
              <p className="text-secondary small mb-0">
                Disponemos de rollos comerciales (4m × 100m) en <strong>130 gsm (óptimo flujo térmico)</strong> y <strong>130 gsm (alta tenacidad mecánica para pimentón)</strong>. 100% HDPE monofilamento virgen, poro ≤192 µm y 5 años de garantía UV contra el sol de Quíbor.
              </p>
            </div>
