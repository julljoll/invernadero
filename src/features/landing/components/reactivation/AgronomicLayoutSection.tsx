      ...
      <div className="container-xl">
        <div className="text-center max-w-2xl mx-auto mb-5">
          <span className="section-kicker mb-2">
            ...
            MÓDULO 01 · MARCO DE SIEMBRA &amp; DISTRIBUCIÓN (3.500 PIMENTONES)
          </span>
          <h2 className="display-6 fw-bold text-dark mb-2">
            Marco de Siembra y Sectorización Hidráulica (3.500 Pimentones)
          </h2>
        ...
        <div className="row g-4 align-items-stretch">
            ...
            <div className="card card-agro p-4 h-100 shadow-sm">
              <div className="d-flex align-items-center justify-content-between mb-3">
                <span className="badge bg-success bg-opacity-25 text-success rounded-pill font-monospace">
                  10 Camellones Dobles (20 Hileras · 3,5 pl/m²)
                </span>
              ...
              <p className="text-secondary small mb-3">
                Suelo franco-arcilloso directo, preparado con labranza mínima para óptima oxigenación radicular del pimentón, con pasillos de 1.20 m:
              </p>
              ...
              <div className="p-3 bg-light rounded-3 border border-secondary-subtle mb-3 font-monospace text-xs text-secondary">
                <div className="d-flex justify-content-between py-1 border-bottom border-secondary-subtle">
                  ...
                  <strong className="text-dark">Franco-arcilloso de Quíbor (drenaje moderado)</strong>
                </div>
                <div className="d-flex justify-content-between py-1 border-bottom border-secondary-subtle">
                  <span>Sistema de Cultivo:</span>
                  <strong className="text-dark">Suelo directo (sin camellones elevados)</strong>
                </div>
                <div className="d-flex justify-content-between py-1 border-bottom border-secondary-subtle">
                ...
                <div className="d-flex justify-content-between py-1 border-bottom border-secondary-subtle">
                  ...
                  <strong className="text-success">~0.29 m (175 plantas / hilera)</strong>
                </div>
                <div className="d-flex justify-content-between pt-1">
                  <span>Población y Densidad Total:</span>
                  <strong className="text-success">3.500 plantas (3.50 plantas/m²)</strong>
                </div>
              </div>

              <div className="alert alert-success bg-success bg-opacity-10 border-success border-opacity-25 small mb-0 text-dark">
                <strong>Doble Cinta por Cama:</strong> 2 líneas de goteo ø16mm, goteros cada 20 cm, 1 L/h. Objetivo: ampliar bulbo húmedo, evitar zonas secas y mantener raíces activas en el 100% de la hilera.
              </div>
            </div>
          </div>
          ...
          <div className="col-12 col-lg-6">
            <div className="card card-agro p-4 h-100 shadow-sm border-info border-opacity-25">
              ...
              <h3 className="fs-5 fw-bold text-dark mb-2">Red de Doble Goteo Autocompensante PC/AS</h3>
              <p className="text-secondary small mb-3">
                Doble cinta por cama (ø16mm, espesor 8-10 mil) con goteros autocompensantes, inmunes a variaciones de presión topográfica:
              </p>
              ...
              <div className="row g-2 mb-3">
                <div className="col-6">
                  <div className="p-3 bg-light rounded-3 border border-secondary-subtle">
                    ...
                    <div className="fs-4 fw-bold font-mono text-dark">5.000 PC</div>
                    <div className="text-secondary text-xs">Caudal 1.00 L/h a 0.20m</div>
                  </div>
                </div>
                <div className="col-6">
                  <div className="p-3 bg-light rounded-3 border border-secondary-subtle">
                    <div className="text-secondary text-xs">División en 2 Sectores</div>
                    <div className="fs-4 fw-bold font-mono text-info">2.50 m³/h</div>
                    <div className="text-secondary text-xs">~1.666 goteros / sector</div>
                  </div>
                </div>
              </div>
