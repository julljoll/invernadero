  ...
  return (
    <div className="space-y-4">
      <div className="card-cockpit p-4">
        ...
        <div className={`alert d-flex flex-column gap-3 mb-4 border ${is60m ? 'alert-success bg-success bg-opacity-10 border-success border-opacity-25' : 'alert-info bg-info bg-opacity-10 border-info border-opacity-25'}`}>
          <div className="d-flex align-items-start gap-3">
            ...
            <div>
              <div className="d-flex flex-wrap align-items-center gap-2 mb-1">
                ...
                {is60m && (
                  <span className="badge bg-success text-white text-xs px-2 py-0.5 rounded-pill">
          ...
          {is60m && (
            <div className="bg-white p-3 rounded-2 border border-success border-opacity-25 shadow-xs">
              ...
              <div className="row g-2 text-xs font-sans text-secondary">
